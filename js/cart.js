  ...
  function saveProduct() {
    ...
    const prodImage = document.getElementById("product-image").src;
    const prodName = document.getElementById("product-name").textContent;
    const prodGameMoney = document.getElementById("game-money").value;
    const prodCount = document.getElementById("count").value;
    const prodPrice =  document.getElementById("product-price").textContent;
    const prodCustomerId =  document.getElementById("customer-id").value;
